...
void ShaderPlanet::initUniforms() {
...
void ShaderPlanet::initTextures() {
...
void ShaderPlanet::update(float tpf) {
...
void ShaderPlanet::draw(float tpf, float time) {
...
void ShaderPlanet::setGViewMatrix(const mat4 &gViewMatrix) {
    g_viewMatrix = gViewMatrix;
}

void ShaderPlanet::setGProjectionMatrix(const mat4 &gProjectionMatrix) {
    g_projectionMatrix = gProjectionMatrix;
}

void ShaderPlanet::setGSunPosition(const vec3 &gSunPosition) {
    g_sunPosition = gSunPosition;
}

void ShaderPlanet::setGCameraPosition(const vec3 &gCameraPosition) {
    g_cameraPosition = gCameraPosition;
}

void ShaderPlanet::setGLightColor(const vec4 &gLightColor) {
