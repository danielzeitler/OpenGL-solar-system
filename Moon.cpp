...
void Moon::initTextures() {

    g_diffuseMap = Texture::LoadTexture(diffuseMap, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR_MIPMAP_LINEAR);
    g_normalMap = Texture::LoadTexture(normalMap, GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR_MIPMAP_LINEAR);
...
void Moon::setGViewMatrix(const mat4 &gViewMatrix) {
    g_viewMatrix = gViewMatrix;
}

void Moon::setGProjectionMatrix(const mat4 &gProjectionMatrix) {
    g_projectionMatrix = gProjectionMatrix;
}

void Moon::setGSunPosition(const vec3 &gSunPosition) {
    g_sunPosition = gSunPosition;
}

void Moon::setGCameraPosition(const vec3 &gCameraPosition) {
    g_cameraPosition = gCameraPosition;
}

void Moon::setGLightColor(const vec4 &gLightColor) {
