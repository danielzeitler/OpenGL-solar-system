...
void SpecialPlanet::initUniforms() {
...
void SpecialPlanet::initTextures() {
...
void SpecialPlanet::update(float tpf) {
...
void SpecialPlanet::setGProjectionMatrix(const mat4 &gProjectionMatrix) {
    g_projectionMatrix = gProjectionMatrix;
}

void SpecialPlanet::setGSunPosition(const vec3 &gSunPosition) {
    g_sunPosition = gSunPosition;
}

void SpecialPlanet::setGCameraPosition(const vec3 &gCameraPosition) {
    g_cameraPosition = gCameraPosition;
}

void SpecialPlanet::setGLightColor(const vec4 &gLightColor) {
